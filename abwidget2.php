...
if (pageindex < 0) {
    document.write("<a href='https://<?php echo $DOMAIN; ?>/comic/" + comic_id + "' title='Read this comic on Archive Binge'><img src='<?php echo $img; ?>' height='<?php echo $height;?>px' width='<?php echo $width;?>px' alt='Read on Archive Binge' class='ab_widget' /></a>");
} else {
    document.write("<a href='http://<?php echo $DOMAIN; ?>/reader/" + comic_id + "/" + pageindex + "' title='Read this comic on Archive Binge'><img src='<?php echo $img; ?>' height='<?php echo $height;?>px' width='<?php echo $width;?>px' alt='Read on Archive Binge' class='ab_widget' /></a>");}
