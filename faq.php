...
<p>Once you\'ve implemented one of these methods, try initiating a recrawl. If it still doesn\'t catch all of the pages, email me the comic url at <a href="mailto:support@DOMAIN.com">support@DOMAIN.com</a> and I\'ll see what I can do.</p>'),
    array(
        'question'=>'Some older pages are missing from my comic\'s listing/reader!',
        'answer'=>'<p>Uhhhhh......Unless you just recently added those pages to your comic (in which case, see next question), I honestly have no idea how that would happen. Please email me your comic at <a href="mailto:support@DOMAIN.com">support@DOMAIN.com</a>. For science. Comic owners can also manually edit the list of pages for their claimed comics on the Edit screen.</p>'),
    array(
    ...
    array(
        ...
        'answer'=>'<p>On your profile page or the Claim page for the comic, you\'ll find a unique Claim token. Drop that token in the author comments or tags of the comic (the comic site, not the AB listing) and <a href="mailto:support@DOMAIN.com">email me</a> the comic page/episode with the token-comment. If the token is valid, I\'ll set you up as the owner of the comic so you can edit the details.</p>')
);
...
<li><a href="/warnings">Warnings</a></li>
    ...
    array(
        ...
        'answer'=>'<p>Probably! If there’s a tag you\'d like to make use of and there\'s nothing close enough in the existing tags, please shoot me an email at <a href="mailto:feedback@DOMAIN.com">feedback@DOMAIN.com</a> and I\'ll consider adding it. I won\'t add tags that are too similar to an existing one, any tags that are offensive (instead of <em>describing</em> offensiveness), tags so generic that literally every comic would fall under it (e.g. a “webcomic” tag) or so specific that they could only ever fit one comic. This means that there won\'t be a tag for “contains stubborn amnesiac jerk that gets himself drowned because of trust issues”.</p>'),
    array(
        'question'=>'You should rename tag/warning [x] to [y].',
        'answer'=>'<p>Email me at <a href="mailto:feedback@DOMAIN.com">feedback@DOMAIN.com</a>. If the issue isn\'t obvious (i.e. I typo\'d a tag/warning), it may help to provide a reason for the change\'s necessity.</p>'),
    array(
        'question'=>'I can\'t use [x] tag on my comic!',
        'answer'=>'<p>Some tags are special and have to be placed on a webcomic by an administrator. Mostly these are tags for collectives or publishers (e.g. Hiveworks, Spider Forest). If your comic belongs to one of these groups or there\'s a special tag applicable to your comic, email me at<a href="mailto:support@DOMAIN.com"> support@DOMAIN.com</a> with the comic page listing and the tag and I can edit it in.</p>'),
    array(
        'question'=>'A comic is missing content warnings!',
        'answer'=>'<p>If the comic is unclaimed, you can add content warnings! If the comic is claimed, unfortunately the comic listing requires the webcomic owner to add the content warnings. If one is missing a content warning and the comic is egregiously in need of one, email me at <a href="mailto:suport@DOMAIN.com">support@DOMAIN.com</a> with the comic, the tag that it needs, and an example from the comic (page url, etc) of the content that necessitates the tag.</p>
...
<p>If you want to go the self-hosting route, you can find some extra info here: <a href="https://nattosoup.blogspot.com/2017/06/self-hosting-your-webcomic-alternatives.html" target="_blank">Self-Hosting Your Webcomic: Alternatives to Tapas, Webtoons</a> or here: <a href="http://freejeeves.com/#creators" target="_blank">Free Jeeves</a></p>'),
    array(
        ...
        'answer'=>'<p>Email me at <a href="mailto:support@DOMAIN.com">support@DOMAIN.com</a> for issues with comic listings, your account, site problems, etc. Email <a href="mailto:feedback@DOMAIN.com">feedback@DOMAIN.com</a> if you have feedback or suggestions. You can also reach me on Twitter <a href="https://twitter.com/HANDLE">@HANDLE</a>.</p>')
);
?>
  </head>
  <body>
